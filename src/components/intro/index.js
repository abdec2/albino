    ...
    return (
        <section className="why-choose padding-top-150 padding-bottom-150" id="about">
            <div className="container">
                <div className="row tw-items-center tw-mb-10 md:tw-mb-0">
                    <div className="col-md-7 tw-mb-10 md:tw-mb-0">
                    ...
                    <div className="col-md-5 text-center">
                        <img src="images/chain-img.png" alt="Why Choose Us Image" className="tw-w-80"/> 
                    </div>
                </div>

                <div className="row tw-mt-10">
                    <div className="col-md-6 col-lg-3 tw-px-2 tw-mb-4 lg:tw-mb-0">
                        <div className="card tw-min-h-full tw-rounded-lg tw-px-4 tw-py-4 tw-shadow-xl">
